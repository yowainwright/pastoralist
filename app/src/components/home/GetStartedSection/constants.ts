...
export const STYLES = {
  ...
  codeBlock:
    "flex h-12 w-fit items-center gap-3 rounded-2xl border border-base-content/10 bg-base-100/85 px-3 shadow-sm shadow-base-content/5 backdrop-blur",
  code: "min-w-0 flex-1 overflow-hidden text-ellipsis whitespace-nowrap text-left text-[0.95rem] font-medium",
  button: "btn btn-lg btn-primary rounded-2xl",
} as const;
