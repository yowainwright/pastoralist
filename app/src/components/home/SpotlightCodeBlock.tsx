...
const codeLines: CodeLine[] = [
  ...
  { prefix: "", content: "Resolving dependencies", className: "text-base-content/60" },
  { prefix: "", content: "Installed pastoralist with binaries:", className: "text-base-content/60" },
  ...
  { prefix: "", content: "💡 Run 'bun install' to apply the changes", className: "text-base-content/60" }
];
