...
function StaticBeforePanel() {
  return (
    <div className="relative flex flex-col">
      <Popover stepNumber={1} {...STEP_POPOVERS[0]} visible={true} />
...
function StaticCliPanel() {
  return (
    <div className="relative">
      <Popover stepNumber={2} {...STEP_POPOVERS[1]} visible={true} />
      <div className="flex items-center gap-2 mb-3">
