...
<video
  aria-label="Patch support sandbox demo"
  ...
  playsInline
  preload="none"
  src="../episodes/pastoralist/07-sandbox-patches/final.mp4"
></video>
...
<video
  aria-label="Cleanup sandbox demo"
  className="my-6 w-full rounded-lg border border-base-content/10"
  height="560"
  width="786"
  controls
  playsInline
  preload="none"
  src="../episodes/pastoralist/05-sandbox-cleanup/final.mp4"
></video>
...
<video
  aria-label="Unused override cleanup demo"
  className="my-6 w-full rounded-lg border border-base-content/10"
  height="560"
  width="786"
  controls
  playsInline
  preload="none"
  src="../episodes/pastoralist/02-cleanup-unused/final.mp4"
></video>
