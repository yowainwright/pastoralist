...
<video
  aria-label="Debug output sandbox demo"
  ...
  playsInline
  preload="none"
  src="../episodes/pastoralist/11-sandbox-debug/final.mp4"
></video>
...
<video
  aria-label="JSON output sandbox demo"
  className="my-6 w-full rounded-lg border border-base-content/10"
  height="560"
  width="786"
  controls
  playsInline
  preload="none"
  src="../episodes/pastoralist/09-sandbox-json-output/final.mp4"
></video>
...
<video
  aria-label="Quiet mode sandbox demo"
  className="my-6 w-full rounded-lg border border-base-content/10"
  height="560"
  width="786"
  controls
  playsInline
  preload="none"
  src="../episodes/pastoralist/13-sandbox-quiet/final.mp4"
></video>
