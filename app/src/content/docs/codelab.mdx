...
>
  **Watch the highlighted dry-run appendix preview:** Pastoralist keeps the
  `qs@6.11.2` override visible, records why it exists, and shows that the
  sandbox can review it before writing.
</EpisodeVideo>
