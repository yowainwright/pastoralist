...
<video
  aria-label="Security scan sandbox demo"
  ...
  playsInline
  preload="none"
  src="../episodes/pastoralist/14-sandbox-security-scan/final.mp4"
></video>
...
<video
  aria-label="Security auto-fix sandbox demo"
  className="my-6 w-full rounded-lg border border-base-content/10"
  height="560"
  width="786"
  controls
  playsInline
  preload="none"
  src="../episodes/pastoralist/16-sandbox-auto-fix/final.mp4"
></video>
...
<video
  aria-label="Security provider setup sandbox demo"
  className="my-6 w-full rounded-lg border border-base-content/10"
  height="560"
  width="786"
  controls
  playsInline
  preload="none"
  src="../episodes/pastoralist/15-sandbox-provider-setup/final.mp4"
></video>
