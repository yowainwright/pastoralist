...
<video
  aria-label="Workspace override tracking demo"
  ...
  playsInline
  preload="none"
  src="../episodes/pastoralist/03-workspaces/final.mp4"
></video>
...
<video
  aria-label="Monorepo sandbox demo"
  className="my-6 w-full rounded-lg border border-base-content/10"
  height="560"
  width="786"
  controls
  playsInline
  preload="none"
  src="../episodes/pastoralist/06-sandbox-monorepo/final.mp4"
></video>
