...
<EpisodeVideo slug="03-workspaces" label="Workspace override tracking demo">
  **Watch the highlighted root override and dry-run update:** Pastoralist keeps
  `lodash@4.17.21` connected to `workspace-demo-app` and `workspace-demo-lib`
...
<EpisodeVideo slug="06-sandbox-monorepo" label="Monorepo sandbox demo">
  **Watch the highlighted monorepo dry-run update:** one root appendix records
  the `lodash@4.17.21` workspace usage instead of duplicating records in each
  package.
</EpisodeVideo>
