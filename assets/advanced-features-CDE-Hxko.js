import{n as e}from"./motion-L-CozVln.js";var t=e();function n(e){let n={code:`code`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...e.components};return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(n.h2,{id:`nested-overrides-transitive-dependencies`,children:`Nested Overrides (Transitive Dependencies)`}),`
`,(0,t.jsx)(n.p,{children:`Pastoralist supports npm's nested override syntax for transitive dependencies.`}),`
...
`})}),`
`,(0,t.jsxs)(n.p,{children:[`This tells npm to use `,(0,t.jsx)(n.code,{children:`pg-types@^4.0.1`}),` whenever `,(0,t.jsx)(n.code,{children:`pg`}),` requests `,(0,t.jsx)(n.code,{children:`pg-types`}),`,
regardless of the version range declared by `,(0,t.jsx)(n.code,{children:`pg`}),`.`]}),`
...
`,(0,t.jsxs)(n.p,{children:[`In monorepos, nested overrides in workspace packages are also tracked. For
example, `,(0,t.jsx)(n.code,{children:`packages/app/package.json`}),` might contain:`]}),`
`,(0,t.jsx)(n.pre,{children:(0,t.jsx)(n.code,{className:`language-json`,children:`{
  "overrides": {
    "pg": {
      "pg-types": "^4.0.1"
...
`})}),`
`,(0,t.jsxs)(n.p,{children:[`With `,(0,t.jsx)(n.code,{children:`--depPaths`}),`, Pastoralist tracks these nested overrides across workspace
packages.`]}),`
`,(0,t.jsx)(n.h2,{id:`patch-support`,children:`Patch Support`}),`
`,(0,t.jsxs)(n.p,{children:[`Pastoralist detects and tracks patches created by tools such as `,(0,t.jsx)(n.code,{children:`patch-package`}),`.`]}),`
...
└── react+18.2.0.patch
`})}),`
`,(0,t.jsx)(n.p,{children:`Pastoralist tracks them in the appendix:`}),`
`,(0,t.jsx)(n.pre,{children:(0,t.jsx)(n.code,{className:`language-json`,children:`{
  "pastoralist": {
    "appendix": {
      "lodash@4.17.21": {
...
`,(0,t.jsxs)(n.p,{children:[`When an override exists but no package in your project depends on it,
Pastoralist labels it as `,(0,t.jsx)(n.code,{children:`(unused override)`}),` in the appendix:`]}),`
`,(0,t.jsx)(n.pre,{children:(0,t.jsx)(n.code,{className:`language-json`,children:`{
  "pastoralist": {
    "appendix": {
      "stale-pkg@1.0.0": {
...
`,(0,t.jsxs)(n.p,{children:[`Set `,(0,t.jsx)(n.code,{children:`keep: true`}),` on a ledger entry to prevent `,(0,t.jsx)(n.code,{children:`--remove-unused`}),` from removing
it:`]}),`
`,(0,t.jsx)(n.pre,{children:(0,t.jsx)(n.code,{className:`language-json`,children:`{
  "lodash@4.17.21": {
    "ledger": {
...
`})}),`
`,(0,t.jsxs)(n.p,{children:[`Pastoralist understands that `,(0,t.jsx)(n.code,{children:`^4.18.0`}),` can resolve to `,(0,t.jsx)(n.code,{children:`4.18.2`}),` without an
...
`,(0,t.jsxs)(n.p,{children:[`Pastoralist complements `,(0,t.jsx)(n.code,{children:`patch-package`}),` by tracking which overrides have
associated patches:`]}),`
