import{n as e}from"./motion-B8hZlCEG.js";var t=e();function n(e){let n={code:`code`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...e.components};return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(n.p,{children:`Pastoralist includes several advanced features that make dependency override management more powerful and maintainable.`}),`
`,(0,t.jsx)(n.h2,{id:`nested-overrides-transitive-dependencies`,children:`Nested Overrides (Transitive Dependencies)`}),`
`,(0,t.jsx)(n.p,{children:`Pastoralist fully supports npm's nested override syntax for overriding transitive dependencies (dependencies of dependencies).`}),`
...
`,(0,t.jsx)(n.p,{children:`Nested overrides are particularly useful for:`}),`
`,(0,t.jsxs)(n.ol,{children:[`
`,(0,t.jsxs)(n.li,{children:[(0,t.jsx)(n.strong,{children:`Security Fixes`}),`: Override vulnerable transitive dependencies without waiting for upstream updates`]}),`
`,(0,t.jsxs)(n.li,{children:[(0,t.jsx)(n.strong,{children:`Bug Fixes`}),`: Apply fixes to deeply nested dependencies`]}),`
`,(0,t.jsxs)(n.li,{children:[(0,t.jsx)(n.strong,{children:`Version Conflicts`}),`: Resolve version conflicts in the dependency tree`]}),`
`,(0,t.jsxs)(n.li,{children:[(0,t.jsx)(n.strong,{children:`Testing`}),`: Test with specific versions of transitive dependencies`]}),`
`]}),`
...
`,(0,t.jsxs)(n.li,{children:[(0,t.jsx)(n.strong,{children:`Visibility`}),`: See which overrides have patches applied`]}),`
`,(0,t.jsxs)(n.li,{children:[(0,t.jsx)(n.strong,{children:`Cleanup Detection`}),`: Get notified about unused patches`]}),`
`,(0,t.jsxs)(n.li,{children:[(0,t.jsx)(n.strong,{children:`Documentation`}),`: Understand why patches exist alongside overrides`]}),`
`]}),`
...
`,(0,t.jsxs)(n.p,{children:[`Pastoralist now considers `,(0,t.jsx)(n.code,{children:`peerDependencies`}),` when tracking override usage.`]}),`
...
`,(0,t.jsx)(n.p,{children:`Pastoralist intelligently matches version ranges to determine if overrides are needed.`}),`
...
`,(0,t.jsx)(n.p,{children:`Pastoralist caches dependency trees during execution to avoid repeated file system reads.`}),`
`,(0,t.jsx)(n.h3,{id:`parallel-processing`,children:`Parallel Processing`}),`
`,(0,t.jsxs)(n.p,{children:[`When using `,(0,t.jsx)(n.code,{children:`--depPaths`}),`, multiple package.json files are processed efficiently.`]}),`
`,(0,t.jsx)(n.h3,{id:`minimal-file-writes`,children:`Minimal File Writes`}),`
`,(0,t.jsx)(n.p,{children:`Package.json is only rewritten if changes are detected, preserving timestamps and reducing unnecessary git changes.`}),`
...
`})}),`
`,(0,t.jsx)(n.h2,{id:`future-proofing`,children:`Future-Proofing`}),`
`,(0,t.jsx)(n.p,{children:`Pastoralist is designed to adapt as package managers evolve:`}),`
`,(0,t.jsxs)(n.ul,{children:[`
`,(0,t.jsxs)(n.li,{children:[(0,t.jsx)(n.strong,{children:`Version compatibility`}),`: Handles different package.json formats`]}),`
`,(0,t.jsxs)(n.li,{children:[(0,t.jsx)(n.strong,{children:`Extensible appendix`}),`: Room for additional metadata`]}),`
`,(0,t.jsxs)(n.li,{children:[(0,t.jsx)(n.strong,{children:`Backward compatibility`}),`: Older versions can read newer appendixes`]}),`
`]}),`
`,(0,t.jsx)(n.h2,{id:`best-practices`,children:`Best Practices`}),`
`,(0,t.jsxs)(n.ol,{children:[`
`,(0,t.jsxs)(n.li,{children:[(0,t.jsx)(n.strong,{children:`Regular Updates`}),`: Run pastoralist regularly, ideally in postinstall`]}),`
`,(0,t.jsxs)(n.li,{children:[(0,t.jsx)(n.strong,{children:`Review Patches`}),`: Periodically review patches for upstream fixes`]}),`
`,(0,t.jsxs)(n.li,{children:[(0,t.jsx)(n.strong,{children:`Document Policies`}),`: Create clear policies for override usage`]}),`
`,(0,t.jsxs)(n.li,{children:[(0,t.jsx)(n.strong,{children:`Monitor Impact`}),`: Track which overrides affect the most packages`]}),`
`,(0,t.jsxs)(n.li,{children:[(0,t.jsx)(n.strong,{children:`Clean Regularly`}),`: Remove overrides as soon as they're not needed`]}),`
