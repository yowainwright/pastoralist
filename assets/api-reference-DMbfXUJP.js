...
<EpisodeVideo slug="11-sandbox-debug" label="Debug output sandbox demo">
  **Look for \`lodash@4.17.20\`, \`qs@6.11.0\`, and \`2 overrides applied\`:** debug
  output shows the decision trail, then warns that one override is unused.
</EpisodeVideo>
...
<EpisodeVideo slug="09-sandbox-json-output" label="JSON output sandbox demo">
  **Look for \`appliedOverrides\`, \`lodash: 4.17.20\`, and \`qs: 6.11.0\`:** JSON
  output exposes the same result as structured fields, including
...
<EpisodeVideo slug="13-sandbox-quiet" label="Quiet mode sandbox demo">
  **Look for \`minimist@1.2.6\`, \`lodash@4.17.21\`, and \`Appendix entries updated:
  2\`:** quiet mode keeps the output compact while preserving the CI status
  signal.
</EpisodeVideo>
