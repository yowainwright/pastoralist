...
<EpisodeVideo
  slug="04-sandbox-basic-overrides"
  label="Basic overrides sandbox demo"
>
  **Look for \`qs@6.11.2\`, \`Used by: 1 package\`, and \`1 unused override
  detected\`:** Pastoralist creates the appendix entry for the sandbox package,
  then points out that the override can be cleaned up.
</EpisodeVideo>
