...
Without Pastoralist, it's easy to lose track of why an override was added, which
...
Pastoralist works with workspace and monorepo setups. It tracks root-level
overrides and shows which workspace packages depend on them.
...
\`depPaths\` is set, it reads workspace package manifests, so the root appendix
can show which packages still need each override.
