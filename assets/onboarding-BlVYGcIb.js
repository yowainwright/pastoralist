import{n as e}from"./motion-L-CozVln.js";var t=e();function n(e){let n={code:`code`,h2:`h2`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,...e.components};return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(n.p,{children:`Use onboarding when you are adding Pastoralist to a repo for the first time or
...
`,(0,t.jsx)(n.pre,{children:(0,t.jsx)(n.code,{className:`language-bash`,children:`pnpm run setup:local-dev -- --dry-run
`})}),`
...
`,(0,t.jsx)(n.pre,{children:(0,t.jsx)(n.code,{className:`language-bash`,children:`pnpm run setup:local-dev -- --agent codex
...
`,(0,t.jsxs)(n.li,{children:[`Run `,(0,t.jsx)(n.code,{children:`pnpm run setup:local-dev -- --dry-run`}),`.`]}),`
