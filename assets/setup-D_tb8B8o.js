...
<EpisodeVideo slug="12-sandbox-setup-hook" label="Setup hook sandbox demo">
  **Look for \`postinstall: pastoralist\`:** Pastoralist checks the package
...
<EpisodeVideo slug="08-sandbox-dry-run" label="Dry-run sandbox demo">
  **Look for \`lodash@4.17.20\`, \`qs@6.11.0\`, \`mime@3.0.0\`, and \`3 overrides
  applied\`:** dry-run prints the package.json change and reports the tracked
  overrides without writing the file.
</EpisodeVideo>
...
<EpisodeVideo slug="10-sandbox-summary" label="Summary sandbox demo">
  **Look for \`lodash@4.17.20\`, \`qs@6.11.0\`, \`cookie@0.7.0\`, and \`Appendix
  entries updated\`:** the summary turns those override updates into reviewable
  counts, including the unused override warning.
</EpisodeVideo>
