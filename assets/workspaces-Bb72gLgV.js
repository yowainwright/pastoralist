...
<EpisodeVideo slug="03-workspaces" label="Workspace override tracking demo">
  **Look for \`lodash@4.17.21\`, \`workspace-demo-app\`, \`workspace-demo-lib\`, and
  \`Used by: 3 packages\`:** Pastoralist keeps the root override connected to the
  workspace packages that still depend on it.
</EpisodeVideo>
...
<EpisodeVideo slug="06-sandbox-monorepo" label="Monorepo sandbox demo">
  **Look for \`lodash@4.17.21\`, \`pastoralist-sandbox-monorepo-app\`,
  \`pastoralist-sandbox-monorepo-lib\`, and \`1 override applied\`:** one root
  appendix records workspace usage instead of duplicating records in each
  package.
</EpisodeVideo>
