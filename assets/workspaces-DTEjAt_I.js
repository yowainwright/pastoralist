import{n as e}from"./motion-BpbLCQiD.js";var t=e();function n(e){let n={code:`code`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...e.components};return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(n.p,{children:`Pastoralist works with workspace and monorepo setups. It tracks root-level
...
`,(0,t.jsx)(n.code,{children:`depPaths`}),` is set, it reads workspace package manifests, so the root appendix
...
`,(0,t.jsx)(n.p,{children:`Pastoralist can configure workspace scanning in three ways:`}),`
`,(0,t.jsx)(n.h3,{id:`method-1-deppaths-in-packagejson`,children:`Method 1: depPaths in package.json`}),`
...
`})}),`
`,(0,t.jsxs)(n.p,{children:[(0,t.jsxs)(n.strong,{children:[`Using `,(0,t.jsx)(n.code,{children:`"workspace"`}),` string`]}),` - Pastoralist uses all packages defined in your `,(0,t.jsx)(n.code,{children:`workspaces`}),` field. The appendix only appears in the root; workspace packages stay clean.`]}),`
...
pastoralist
`})}),`
`,(0,t.jsxs)(n.p,{children:[`This manages overrides in your root `,(0,t.jsx)(n.code,{children:`package.json`}),`, which affect all workspaces.`]}),`
...
`,(0,t.jsx)(n.h3,{id:`strategy-1-centralized-management-with-deppaths`,children:`Strategy 1: Centralized Management with depPaths`}),`
...
`,(0,t.jsx)(n.h3,{id:`ci-integration`,children:`CI Integration`}),`
...
`,(0,t.jsxs)(n.p,{children:[(0,t.jsx)(n.strong,{children:`Solution:`}),` Use a package manager that supports workspace overrides:`]}),`
`,(0,t.jsxs)(n.ul,{children:[`
...
`,(0,t.jsx)(n.li,{children:`Update CI scripts`}),`
