...
Pastoralist manages overrides and resolutions so you don't have to! It is comprised of a few functions which read node_modules package.json files and reduce overrides or resolutions within the root package.json into a single `pastoralist.appendix` object.
