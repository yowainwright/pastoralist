...
const paths = [".npmrc", "patches"];
const executablePaths = [".pnpmfile.cjs", ".pnpmfile.js", ".pnpmfile.mjs"];
const guards = [
...
export const REMOVAL: RemovalConfig = { args, paths, executablePaths, guards };
